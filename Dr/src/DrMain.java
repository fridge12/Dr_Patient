...
public class DrMain {
	...
	public static void main ( String args[]) {
		...
		objArray[0]= new DrMain();
		objArray[0].createLoginFrame();
		objArray[0].createLoginContents(objArray[0].loginFrame,0);
		
		objArray[1]= new DrMain();
		objArray[1].createLoginFrame();
		objArray[1].createLoginContents(objArray[1].loginFrame,1);
	...
	public void createLoginContents(JFrame frame, int objPosition) {
		...
		adminButton.addMouseListener(new MouseAdapter (){
			...
			public void mouseReleased(MouseEvent e ) {
				...
				objArray[objPosition].createAdminFrame();
